...
const Music = ({ navigation }) => {
    ...
    useEffect(()=>{
        ...
        dispatch({ type: 'CHANGE_Categorie_STATUS',payload:'Music'})
    ...
    const headerList=()=>{
        return(
            <View>
                 <StatusBar backgroundColor="#DB7093" style="light" />
            <Headerr nav={navigation} nameIconRight={'search'} centerIcon={'Music'} />
            <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 10 }}>
            <Text style={{ fontWeight: 'bold', fontSize: 30 ,color:'#DB7093'}}> 03 </Text>
            <Text style={{ fontSize: 30 ,color:'#DB7093'}}>Concerts</Text>
        ...
        return (
            ...
            <TouchableOpacity style={styles.containerList} onPress={() =>
                navigation.navigate('Details', {
                    screen: 'Resume',
                    params: { img: item.item.img  , data: item  ,category:'Music'}
                  })
